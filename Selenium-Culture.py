...
link_news_page = "https://us.fashionnetwork.com"
...
for href in href_list:
    try:
        ...
        content_p_elements = driver.find_elements(By.XPATH,
                                      '//div[contains(@class,"newsContent")]//p')

        content = ""
        for el in range(len(content_p_elements)):
            content += content_p_elements[el].text
            content += " "
        #print(f"Content {content}")

        try:
            image_url = driver.find_element(By.XPATH,'//img[@class="news-image"]')
        except:
            image_url = \
